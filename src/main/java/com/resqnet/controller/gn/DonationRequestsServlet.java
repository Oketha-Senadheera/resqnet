...
public class DonationRequestsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // Load all donation requests and separate by status
        List<DonationRequest> allRequests = requestDAO.findAll();
        List<DonationRequest> pendingRequests = new ArrayList<>();
