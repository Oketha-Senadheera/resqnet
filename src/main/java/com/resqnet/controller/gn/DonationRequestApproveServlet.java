...
@WebServlet("/gn/donation-requests/approve")
public class DonationRequestApproveServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            donationRequestDAO.approve(requestId);

            resp.sendRedirect(req.getContextPath() + "/gn/donation-requests?success=approved");
