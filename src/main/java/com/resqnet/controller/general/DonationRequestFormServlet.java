...
@WebServlet("/general/donation-requests/new")
public class DonationRequestFormServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // Load donation items catalog
        List<DonationItemsCatalog> catalogItems = catalogDAO.findAll();
        req.setAttribute("catalogItems", catalogItems);

        req.getRequestDispatcher("/WEB-INF/views/general-user/donation-request-form.jsp").forward(req, resp);
    }
}
