...
public class DonationRequestFormServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // Fetch all donation items for the form
        List<DonationItemsCatalog> items = itemsCatalogDAO.findAll();
        req.setAttribute("catalogItems", items);

        req.getRequestDispatcher("/WEB-INF/views/general-user/donation-requests/donation-request-form.jsp").forward(req, resp);
    }
}
