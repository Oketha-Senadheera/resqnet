...
@WebServlet("/dmc/disaster-reports/verify")
public class DisasterReportVerifyServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            resp.sendRedirect(req.getContextPath() + "/dmc/disaster-reports?success=verified");
        } catch (Exception e) {
            e.printStackTrace();
            resp.sendRedirect(req.getContextPath() + "/dmc/disaster-reports?error=verify");
        }
    }
}
