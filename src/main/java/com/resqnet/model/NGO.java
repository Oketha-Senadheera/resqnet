...
public class NGO {
    ...
    public NGO(int userId, String organizationName, String registrationNumber, Integer yearsOfOperation,
              String address, String contactPersonName, String contactPersonTelephone, String contactPersonEmail) {
        this.userId = userId;
