...
public class DisasterReportDAO {
    ...
    public int create(DisasterReport report) {
        String sql = "INSERT INTO disaster_reports(user_id, reporter_name, contact_number, disaster_type, " +
                     "other_disaster_type, disaster_datetime, location, proof_image_path, confirmation, status, description) " +
                     "VALUES(?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public void update(DisasterReport report) {
        ...
        try (Connection con = DBConnection.getConnection();
            ...
            ps.setBoolean(8, report.getConfirmation() != null ? report.getConfirmation() : true);
    ...
    public List<DisasterReport> findByUserId(int userId) {
        ...
        try (Connection con = DBConnection.getConnection();
            ...
            throw new RuntimeException("Error fetching disaster reports by user", e);
        }
        return reports;
    }
