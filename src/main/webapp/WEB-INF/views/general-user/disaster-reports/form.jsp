...
<layout:general-user-dashboard pageTitle="ResQnet - Report a Disaster" activePage="report-disaster">
  <jsp:attribute name="styles">
    <style>
      /* Small page-scoped layout helpers (reuse tokens) */
      ...
      .btn.primary { background: var(--color-accent); border-color: var(--color-accent); font-weight:600; }
  ...
  <jsp:body>
    ...
    <c:if test="${param.error == 'datetime'}">
      <div class="alert alert-error">Invalid date/time format.</div>
    </c:if>
    ...
    <form id="reportDisasterForm" method="post" action="${pageContext.request.contextPath}/general/disaster-reports/submit" enctype="multipart/form-data">
