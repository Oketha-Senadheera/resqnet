  ...
  <body>
    <div class="layout">
      <aside class="sidebar" aria-label="Primary">
        ...
        <div class="sidebar-footer"><button class="logout" aria-label="Logout" onclick="handleLogout()">↩ Logout</button></div>
      </aside>
      <header class="topbar">
        ...
        <div class="topbar-right">
          ...
          <div class="user-avatar" aria-label="User Menu" role="button" title="${sessionScope.authUser.email}"><img src="https://via.placeholder.com/40x40.png?text=U" alt="User Avatar" /></div>
